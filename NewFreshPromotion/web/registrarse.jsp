...
<%
    ...
    String accion="", nombre="", app="", correo="", password="";
    ...
    <body>
        ...
        <div class="row bg-warning" style="margin-left: 25%; margin-right: 25%; margin-top: 5%; margin-bottom: 5%; border-radius: 5%;">
            <div class="col">
                ...
                <form action="registrarse.jsp" method="POST" style="padding-top: 5%; padding-left: 20%;">
                    ...
                    <div class="form-group row" style="padding-left: 10%; padding-top: 5%">
                        <div class="col-4">
                            <input type="submit" class="btn btn-success" style="width: 100%; font-size: 20px;" name="accion" value="Registrarse"><!-- BOTON INICIAR SESION -->
                        </div>
                        <div class="col-4">
